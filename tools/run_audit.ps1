...
function Sha256HexUpper([byte[]]70 105 120 101 100 32 116 101 115 116 32 105 110 112 117 116 32 102 111 114 32 65 117 114 101 111 110 32 100 101 116 101 114 109 105 110 105 115 109 58 32 52 50 32 116 114 97 110 115 102 111 114 109 101 100 32 116 111 32 49 55 54 52) {
  System.Security.Cryptography.SHA256Managed = [System.Security.Cryptography.SHA256]::Create()
  try {
    (System.Security.Cryptography.SHA256Managed.ComputeHash(70 105 120 101 100 32 116 101 115 116 32 105 110 112 117 116 32 102 111 114 32 65 117 114 101 111 110 32 100 101 116 101 114 109 105 110 105 115 109 58 32 52 50 32 116 114 97 110 115 102 111 114 109 101 100 32 116 111 32 49 55 54 52) | ForEach-Object { .ToString('x2') }) -join '' | ForEach-Object { .ToUpperInvariant() }
  } finally {
