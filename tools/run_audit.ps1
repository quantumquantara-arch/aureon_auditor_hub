...
# Fixed input / deterministic transform
 ...
 =  + ' transformed to ' + (42 * 42).ToString()
# Expected hash (uppercase hex)
 = '37FD88D52D1299721B7B697F37DDC4419E0ADDE5611D22C46B5B77B9BECE6759'
function Sha256HexUpper {
  param(
    [byte[]]70 105 120 101 100 32 116 101 115 116 32 105 110 112 117 116 32 102 111 114 32 65 117 114 101 111 110 32 100 101 116 101 114 109 105 110 105 115 109 58 32 52 50 32 116 114 97 110 115 102 111 114 109 101 100 32 116 111 32 49 55 54 52
  )
